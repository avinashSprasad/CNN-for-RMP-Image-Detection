...
class CustomEfficientNet(nn.Module):
    def __init__(self, num_classes=2, num_levels=256):
        ...
        self.co_occurrence = GrayGLCM(num_levels=num_levels)



        cooc_channels = 2 * 3  # 2 directions * 3 channels (RGB)

        glcm_channels = len(self.co_occurrence.distances) * len(self.co_occurrence.angles)
