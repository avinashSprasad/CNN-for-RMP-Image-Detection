...
from Co_OCURRENCE_YCBCR import CoOccurenceProcessor


# -------------------- WANDB SETUP --------------------
wandb.init(
    project="EfficientNet",              # ✅ New wandb project name
    name="EfficientNetYCBCR",                   # ✅ Run name
    mode="online",
...
class CustomEfficientNet(nn.Module):
    def __init__(self, co_occurrence, num_classes=1):
        ...
        self.stem = nn.Sequential(
            nn.Conv2d(12, 32, kernel_size=3, stride=2, padding=1, bias=False),  # <- changed from 4 to 12
            nn.BatchNorm2d(32),
            nn.ReLU(inplace=True)
        )
